/*********************************************************************
 *
 * $Id: yocto_humidity.cpp 10245 2013-03-11 13:35:54Z seb $
 *
...
std::map<string,YHumidity*> YHumidity::_HumidityCache;
...
{
    if(YHumidity::_HumidityCache.find(func) != YHumidity::_HumidityCache.end())
        return YHumidity::_HumidityCache[func];
    
    YHumidity *newHumidity = new YHumidity(func);
    YHumidity::_HumidityCache[func] = newHumidity;
