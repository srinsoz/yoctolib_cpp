/*********************************************************************
 *
 * $Id: yocto_carbondioxide.h 10245 2013-03-11 13:35:54Z seb $
 *
...
protected:
    ...
    static std::map<string,YCarbonDioxide*> _CarbonDioxideCache;
    ...
    YCarbonDioxide(const string& func): YFunction("CarbonDioxide", func)
