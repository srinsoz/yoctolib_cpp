/*********************************************************************
 *
 * $Id: yocto_temperature.h 10245 2013-03-11 13:35:54Z seb $
 *
...
protected:
    ...
    static std::map<string,YTemperature*> _TemperatureCache;
    ...
    YTemperature(const string& func): YFunction("Temperature", func)
